  ...
  return (
    <>
      ...
      <p className="styled-paragraph">
        This Privacy Policy applies to your Personal Information collected or processed by
        D & A Technologies LLC d/b/a Rapptr Labs, and/or its affiliated entities
        (collectively, “Rapptr Labs,” “we,” “us” or “our”), through their websites or
        other sites that display or are linked to this Privacy Policy (collectively, the
        “Site” or “Sites”). This Privacy Policy applies to your Personal Information,
        which can include information or a combination of information that could directly
        or indirectly be used to identify you, in particular by reference to an identifier
        such as a name, an email, login credentials, an online identifier, and any other
        information collected from or about you (hereinafter, “Personal Information”).
        Please note, the definition of Personal Information can vary by jurisdiction. If
        we collect information from you that is considered Personal Information in your
        jurisdiction, we will treat it as such in accordance with this Privacy Policy.
      </p>
      <p className="styled-paragraph">
        Our site may contain links to third-party websites and services that are not owned
        or controlled by Rapptr Labs. We are not responsible for the privacy practices or
        the content of third-party websites, services, advertisements, and you visit them
        at your own risk.
      </p>
      <p className="styled-paragraph">
        Please read this Privacy Policy carefully to understand our policies and practices
        regarding your Personal Information and how we will treat it. This Privacy Policy
        may change from time to time. We will notify you of material changes to this
        Privacy Policy by posting a notice on our home page for a reasonable period of
        time and changing the “Last Updated” legend at the top of this page So please
        check the Site periodically for updates
      </p>

      <p className="styled-paragraph">
        The terms used in this Privacy Policy have the same meanings as in our Terms and
        Conditions, which is accessible at https://www.rapptr-labs.com, unless otherwise
      ...
      <p className="styled-paragraph">
        ...
        your name, phone number, and postal address. The information that we collect will
      ...
      <p className="styled-paragraph">
        ...
        improve our Service. You have the option to either accept or refuse these cookies,
        and know when a cookie is being sent to your computer. If you choose to refuse our
